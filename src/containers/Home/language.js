const language = {
  ...
  es: {
    ...
    data: [
      "Soy un apasionado Desarrollador Web Fullstack con +2.5 años de experiencia. Tengo experiencia creando aplicaciones web con JavaScript / TypeScript / Solidity / React.js / Redux / React-native / Node.js / Express / PostgreSQL / MySQL / Sequelize / MongoDB / Mongoose / AWS / Redis / HTML5 / CSS / SASS.",
